...
Input the file name you want: Use single quotes when writing file name such as: 'Test': '3DPlot_Antenna_Geometry_a1'
Data saved in/path/3DPlot_Antenna_Geometry_a1.mat
...
Selct the folder in the UI: 
Input the file name you want: Use single quotes when writing file name such as: 'Test': 'Antenna_Geometry_Results_a1'
Data saved in/path/Results_a1.mat
...
Plot section: 
========================File Selection===================================
User selected in/path/3DPlot_Antenna_Geometry_a1.mat
